...
$T_{00}$ NFW-class extremes, where the chirality-flip-AUC drops
to $0.603$ as the support thins below the per-node chirality-
flip's resolution). The chirality-flip is therefore a broad
matter-side classifier with the $K, Q$ harmonic-closure
matter-core ($\gamma/2$) as its algebraic anchor and the
geometric defect extreme ($\gamma^{2}/2$) as the resolution
floor; its observable peak at $\gamma^{2}$ corresponds to the
quadratic-tier matter-side support intermediate between the
two. See
