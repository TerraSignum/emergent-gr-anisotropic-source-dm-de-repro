...
P5N pool (matter-core support at top-$5\%$ and top-$1\%$
$t_{00}(a)$; per
\path|src/verify_chirality_local_RG_window.py| on the canonical
P5N pool) yields the fixed-$\pi/4$ enrichment ratios
$1.67\!\times$ (top-$5\%$) and $1.74\!\times$ (top-$1\%$),
monotone with the percentile cut and consistent with the
fine-percentile audit's location of the matter-core support in
the heavy tail of $t_{00}$. See
