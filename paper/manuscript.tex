...
The signal increases monotonically over the BULK -- TRANSITION
band (top-$10\%$ -- top-$1\%$) and peaks at the top-$1\%$ cut,
then drops to near-unity at the strict matter-core extreme
(top-$0.5\%$). This places the chirality-flip's
matter-side support in the heavy tail of $t_{00}$ around the
$p_{99}$ band, distinct from the absolute matter-core extreme
$p_{99.5}+$ (the geometric defect-localised cores identified by
the closure-defect / $R_{00}$ / $T_{00}$ extremes in the
companion fine-percentile audit) -- a structural distinction
between the chirality-flip's matter-side region and the
narrower defect-localised core. See
